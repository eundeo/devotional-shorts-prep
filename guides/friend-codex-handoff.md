...
> 비공개 저장소: `eundeo/devotional-shorts-prep`  
> 인수 버전: `v1.0.1`  
...
- 비공개 저장소의 `v1.0.1`을 검증하고 플러그인을 설치·활성화함
...
- 저장소 소유자가 지인의 GitHub 계정을 협업자로 초대했고 지인이 수락함
...
접근할 수 없다면 공개 전환이나 우회를 시도하지 말고, 소유자에게 정확한 GitHub 사용자명을 전달해 초대받도록 안내한다.
...
| 저장소 접근 불가 | 초대 수락·로그인 계정 확인 후 소유자에게 초대 요청 |
