...
[2026-09-08 사용 준비·배포·운영 보완 결과](operations-readiness-2026-09-08.md): OPS-02·03·04·06·08 내부 수정과 OPS-05·09 운영 정책 반영 완료. `1.0.1` 신규·업데이트 설치와 공개 GitHub 소스·태그·Release 게시 완료, Telegram 실환경 인수는 대기한다.
